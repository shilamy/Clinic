...
public class Login extends javax.swing.JFrame {
    ...
    try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/clinicdb", "root", "");
         PreparedStatement stmt = con.prepareStatement("SELECT * FROM userlogin WHERE username = ? AND password = ?")) {
        ...
        JOptionPane.showMessageDialog(this, "Database" + e.getMessage());
    }
